...
public class RestMediaType extends MediaType {
    ...
    static {
        ...
        APPLICATION_PATCH_JSON = new RestMediaType( valueOf( APPLICATION_MERGE_PATCH_JSON_VALUE ) );
    }

    public RestMediaType(MediaType mediaType){
        super(mediaType, (Map<String, String>) null);
    }
